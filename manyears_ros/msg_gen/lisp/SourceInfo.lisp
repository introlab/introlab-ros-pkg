...
(cl:defclass <SourceInfo> (roslisp-msg-protocol:ros-message)
  ((source_id
   ...
   (latitude
    ...
    :initform 0.0)
   (source_energy
    :reader source_energy
    :initarg :source_energy
    :type cl:float
    :initform 0.0)
   (separation_data
...
(cl:defmethod cl:initialize-instance :after ((m <SourceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SourceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name manyears_ros-msg:<SourceInfo> is deprecated: use manyears_ros-msg:SourceInfo instead.")))

(cl:ensure-generic-function 'source_id-val :lambda-list '(m))
(cl:defmethod source_id-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:source_id-val is deprecated.  Use manyears_ros-msg:source_id instead.")
  (source_id m))

(cl:ensure-generic-function 'source_pos-val :lambda-list '(m))
(cl:defmethod source_pos-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:source_pos-val is deprecated.  Use manyears_ros-msg:source_pos instead.")
  (source_pos m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:longitude-val is deprecated.  Use manyears_ros-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:latitude-val is deprecated.  Use manyears_ros-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'source_energy-val :lambda-list '(m))
(cl:defmethod source_energy-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:source_energy-val is deprecated.  Use manyears_ros-msg:source_energy instead.")
  (source_energy m))

(cl:ensure-generic-function 'separation_data-val :lambda-list '(m))
(cl:defmethod separation_data-val ((m <SourceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader manyears_ros-msg:separation_data-val is deprecated.  Use manyears_ros-msg:separation_data instead.")
  (separation_data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SourceInfo>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'latitude))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'source_energy))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SourceInfo>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'source_pos) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'source_energy) (roslisp-utils:decode-single-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SourceInfo>))
  ...
  (cl:list 'SourceInfo
    ...
    (cl:cons ':source_energy (source_energy msg))
